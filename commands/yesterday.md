...
3. Run it as a **review, not a re-read**: show the flashcard fronts and the mini-quiz questions, ask the user to answer from memory, and wait. Only after they answer, reveal the gabarito and correct gently.
