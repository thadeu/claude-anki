...
Selector from the user (optional): `$ARGUMENTS` — may be a date (AAAA-MM-DD), a topic keyword, or empty.
...
3. Run it as a review: quiz first (flashcard fronts + mini-quiz), wait for answers, then reveal the gabarito and correct gently.

Explain in Portuguese, examples in English, encouraging tone, no profanity.
